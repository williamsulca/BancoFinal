...
public class Controlador {
    ...
    public String getNroCuentaByCliente(@PathVariable("idClienteLogeado") int idClienteLogeado) {
       ...
       @RequestMapping(value = "/getlogin/{idClienteLogeado}", method = RequestMethod.GET)
    public RptaMovimiento getlogin(@PathVariable("idClienteLogeado") int idClienteLogeado) {
        return servicio.getMovimientos(idClienteLogeado);
    }
